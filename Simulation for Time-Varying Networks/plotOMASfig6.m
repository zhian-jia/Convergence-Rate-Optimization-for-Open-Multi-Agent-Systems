%% The data used in this paper(Load to obtain Fig. 6)
kmax=80;nN=50;CList=slanCL(11,1:nN);
ty=load("open-t.mat");t=ty.t;T=numel(t);
Xy=load("open-X.mat");X=Xy.X;
Xady=load("open-Xad.mat");Xad=Xady.Xad;
%% 
zero=zeros(1,kmax);
s=zeros(1,kmax);
for k=1:1:kmax
